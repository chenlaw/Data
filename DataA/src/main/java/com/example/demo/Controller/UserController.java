...
public class UserController {
    ...
    //todo:系统调用选课
//    @GetMapping("/syspick")
//    public ResponseVO pickCourse(@RequestParam("file") MultipartFile mfile, @RequestParam("Cno") String cno) throws IOException, JAXBException {
//        return userService.pickCourse(mfile,cno);
//    }
