...
//    //调用的url格式是：String url="http://127.0.0.1:8081/course/kik?fileName=123.xml&type1=A&type2=B&sno=asdf&cno=asdf";
...
//        String chooseurl=url2+"/user/pick?sno="+request.getParameter("sno")+"&cno="+request.getParameter("cno");
