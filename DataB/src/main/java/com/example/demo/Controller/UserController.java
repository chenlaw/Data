...
public class UserController {
    ...
    //todo:系统调用选课
    @PostMapping("/syspick")
    public ResponseVO pickCourse(@RequestParam("Sno") String sno, @RequestParam("Cno") String cno,@RequestParam("Student") MultipartFile mfile) throws IOException, JAXBException {
        File file= FileUtil.MultipartFileToFile(mfile);
        return userService.syspickCourse(sno,cno);
    }
